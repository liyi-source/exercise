package com.ly.chat.managerchat.util;
...
//    public static final String KEY = "1234567887654321";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
    public static final String KEY = "gwhndlgsdkMc7mbS";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
    ...
    */
    public static String aesDecrypt(String data, String key) {
        ...
        try {
            return new String(decrypt(parseHexStr2Byte(data), key),"UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return null;
