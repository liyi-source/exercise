package com.ly.upload.managentupload.util;
...
public class UploadUtils {
    ...
    private final static Log logger = LogFactory.getLog(UploadUtils.class);
    /** 本地字符编码 */
    ...
    public static void main(String[] args) throws FileNotFoundException {
        //ftp服务器IP地址
        String ftpHost = "172.16.7.41";
        //ftp服务器端口
        int ftpPort = 21;
        //ftp服务器用户名
        String ftpUserName = "ftpuser";
        //ftp服务器密码
        String ftpPassword = "ly9398qq521";
        //ftp服务器路径
        String ftpPath = "img/";
        //本地路径
        String localPath = "E://ftp";
        //文件名
        String fileName = "狗.jpg";
...
//        downloadFtpFile(ftpHost, ftpUserName, ftpPassword, ftpPort, ftpPath, localPath, fileName);
        ...
        //上传
        //将E盘的文件上传至ftp根目录
//        FileInputStream in=new FileInputStream(new File("E://ftp/" + fileName));
//        uploadFile(ftpHost, ftpPort, ftpUserName, ftpPassword, "ftpfile/", "/", fileName, in);

        //删除
        //删除ftp根目录下的文件
        deleteFile(ftpHost, ftpPort, ftpUserName, ftpPassword, "ftpfile/", fileName);
